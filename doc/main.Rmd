...
em_step <- function(data = movie_UI, C = 5, tau = 0.5, iter = 100)
```
...
movie_pred <- function(data = data, gamma = gamma, assign_mat = assign_mat)
ms_pred <- function(data = data, gamma = gamma, assign_mat = assign_mat)
