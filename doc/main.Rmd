...
#Step2: Calculate similarity weights
...
#Step3: Adding significance weights and variance weights
...
# So the observed matrix is MS_observed_UI, and movie_observed_UI


ranked_scoring(MS_pred, MS_observed_UI,10,0.02)
ranked_scoring(MS_pred_spm, MS_observed_UI,10)
ranked_scoring(MS_pred_sqd, MS_observed_UI,10)
ranked_scoring(MS_pred_cos, MS_observed_UI,10)
ranked_scoring(MS_pred_ent, MS_observed_UI,10)
ranked_scoring(MS_pred_sim, MS_observed_UI,10)
